...
prefixCommands = Array( _
    "netsh interface ipv6 set prefixpolicy ::1/128 50 0", _
    "netsh interface ipv6 set prefixpolicy ::/0 40 1", _
    "netsh interface ipv6 set prefixpolicy ::ffff:0:0/96 35 4", _
    "netsh interface ipv6 set prefixpolicy 2002::/16 30 2", _
    ...
    "netsh interface ipv6 set prefixpolicy ::/96 1 3" _
)
